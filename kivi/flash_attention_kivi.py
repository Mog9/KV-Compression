"""
Flash Attention implementation for KIVI quantized KV cache.
...
# Add kivi directory to path
sys.path.insert(0, str(Path(__file__).parent))

from kivi_triton import dequantize_keys_triton, dequantize_values_triton
...
def flash_attention_kivi(query, kivi_cache):
    """
    Compute Flash Attention with KIVI quantized KV cache.
    
    Args:
        query: [B, H, Q_LEN, D] query tensor
        kivi_cache: KIVIKVCacheTriton instance
